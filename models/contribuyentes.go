...
// Empresa representa a una empresa
type Empresa struct {
	ID                       string    `json:"id" bson:"_id,omitempty"`
	RUT                      string    `json:"rut" bson:"rut"`
	RazonSocial              string    `json:"razon_social" bson:"razon_social"`
	NombreFantasia           string    `json:"nombre_fantasia,omitempty" bson:"nombre_fantasia,omitempty"`
	...
	Telefono                 string    `json:"telefono,omitempty" bson:"telefono,omitempty"`
	Email                    string    `json:"email,omitempty" bson:"email,omitempty"`
	SitioWeb                 string    `json:"sitio_web,omitempty" bson:"sitio_web,omitempty"`
	ActividadEconomica       string    `json:"actividad_economica" bson:"actividad_economica"`
	CodigoActividadEconomica string    `json:"codigo_actividad_economica" bson:"codigo_actividad_economica"`
